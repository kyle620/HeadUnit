...
/* The following macros address different GPU specific optimizations and
   ...
   EW_EXCHANGE_RED_BLUE_CHANNELS, if set 1, instructs the OpenGL driver to
   exchange the red and blue channels in all color values received from the
   upper layer of the Graphics Engine. If set 0, the original color channel
   order RGBA as expected by OpenGL is used. */
...
#ifndef EW_EXCHANGE_RED_BLUE_CHANNELS
  #define EW_EXCHANGE_RED_BLUE_CHANNELS         0
#endif
...
/* When using the workaround to exchange the red/blue channels also adjust the
   color order of how bitmaps are stored. */
#if EW_EXCHANGE_RED_BLUE_CHANNELS
...
#define EwGfxCreateRGB565Surface    OpenGLCreateSurface
...
#define EwGfxDestroyRGB565Surface   OpenGLDestroySurface
...
#define EwGfxLockRGB565Surface      OpenGLLockSurface
...
#define EwGfxUnlockRGB565Surface    OpenGLUnlockSurface
...
#define EwGfxAdjustRGB565SurfaceSize OpenGLAdjustSurfaceSize
...
#define EwGfxCopyRGB565                 OpenGLCopyDriver
#define EwGfxCopyRGB565Blend            OpenGLCopyDriver
#define EwGfxCopyRGB565Gradient         OpenGLCopyDriver
#define EwGfxCopyRGB565GradientBlend    OpenGLCopyDriver
...
#define EwGfxWarpPerspRGB565                        OpenGLWarpDriver
#define EwGfxWarpPerspRGB565Gradient                OpenGLWarpDriver
#define EwGfxWarpPerspRGB565GradientBlend           OpenGLWarpDriver
#define EwGfxWarpPerspRGB565Filter                  OpenGLWarpDriver
#define EwGfxWarpPerspRGB565FilterGradient          OpenGLWarpDriver
#define EwGfxWarpPerspRGB565FilterGradientBlend     OpenGLWarpDriver
...
#define EwGfxWarpAffineRGB565                       OpenGLWarpDriver
#define EwGfxWarpAffineRGB565Gradient               OpenGLWarpDriver
#define EwGfxWarpAffineRGB565GradientBlend          OpenGLWarpDriver
#define EwGfxWarpAffineRGB565Filter                 OpenGLWarpDriver
#define EwGfxWarpAffineRGB565FilterGradient         OpenGLWarpDriver
#define EwGfxWarpAffineRGB565FilterGradientBlend    OpenGLWarpDriver
